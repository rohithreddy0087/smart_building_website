...
const Home = () => {
    const text1 = "Smart Building Research @ UC San Diego";
    const text2 = "Recent advancements in learning and control have opened doors for researchers to operate and\
        optimize building energy management systems autonomously. However, the lack of an easily\
        configurable building dynamical model and energy management simulation and evaluation\
        platform has arguably slowed the progress in developing advanced learning and control\
        algorithms for building operation tasks. We present an holistic framework for processing and visualizing the individual building\
        consumption data";
    return (
    <Box>
